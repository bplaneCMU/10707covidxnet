...
if __name__ == "__main__":
    ...
    train_loader = torch.utils.data.DataLoader(train_set, batch_size=BATCH_SIZE, shuffle=True, num_workers=os.cpu_count())
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if (recall + accuracy + precision) > best_statsum:
            ...
            print("new best!")
            torch.save(model.state_dict(), "experiment_a.pkl")
